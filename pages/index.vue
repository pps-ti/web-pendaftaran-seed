<template>
  <div class="container grid">
    <form id="form" @submit.prevent="onSubmit">
      <h1 class="form-title">
        Pendaftaran <strong>SEED #2</strong> telah ditutup
      </h1>
        ...
        <div v-if="formStep === 1" class="form-page form-page--1">
          ...
          <vs-row>
            <vs-input v-model="nama" placeholder="Nama">
              <template
                v-if="
                  $v.nama.$error || (!$v.nama.required && nama !== undefined)
                "
                #message-danger
              >
                Harus diisi
          ...
          <vs-row class="gender-row">
            ...
            <vs-radio v-model="gender" name="gender" val="P"
              >Perempuan</vs-radio
            >
          </vs-row>
          <vs-row>
            <vs-input v-model="surel" type="email" placeholder="Alamat email">
              ...
              <template #message-danger>
                ...
                <span
                  v-if="
                    $v.surel.$error ||
                    (!$v.surel.required && surel !== undefined)
                  "
                >
                  Harus diisi
                </span>
